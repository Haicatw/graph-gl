...
var GLLegend = function () {
  ...
  _createClass(GLLegend, [{
    ...
    key: 'convertToWorldSpace',
    value: function convertToWorldSpace(x, y, cam) {
      ...
      var distance = -cam.position.z / screenPos.z;
    ...
    value: function getWorldPositionTopLeft() {
      var x = -2; // -this.domElement.width / 2 + 10
      var y = 0.5; // this.domElement.height / 2 - 10
      var screenPos = new THREE.Vector3(x, y, 0.5);
      console.log(screenPos);
      var pos = new THREE.Vector3();
