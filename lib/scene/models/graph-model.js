...
var GraphModel = function () {
  ...
  _createClass(GraphModel, [{
    ...
    key: 'updateEdgePos',
    value: function updateEdgePos(edge) {
      if (!edge.curve) {
        edge.positions = {
          source: { x: this.model.nodeMap[edge.source].x, y: this.model.nodeMap[edge.source].y, z: 0 },
          target: { x: this.model.nodeMap[edge.target].x, y: this.model.nodeMap[edge.target].y, z: 0 }
        ...
        try {
          for (var _iterator2 = edge.positions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
